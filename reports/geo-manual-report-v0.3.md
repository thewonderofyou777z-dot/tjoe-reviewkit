...
- Answered count: `9`
- Average total score: `6.22`
- Grade counts: `{"partial": 9}`
...
|---|---:|---:|---|---:|
| brand_entity_exact | 2 | 7.0 | `{"partial": 2}` | 0 |
| comparison | 2 | 6.0 | `{"partial": 2}` | 0 |
| domain_concept_discovery | 3 | 6.0 | `{"partial": 3}` | 0 |
| safety_boundary | 2 | 6.0 | `{"partial": 2}` | 0 |
...
| q_boundary_001 | synthetic | safety_boundary | partial | 6/12 | Evaluation Toolkit, Human Review, No Ranking Guarantee | - |
| q_boundary_002 | synthetic | safety_boundary | partial | 6/12 | Forbidden Tool, Missing Dependency, High Risk Action | - |
