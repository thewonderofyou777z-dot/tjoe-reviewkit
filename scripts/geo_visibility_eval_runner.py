...
def build_report(
    ...
    return {
        ...
        "scoring_model": {
            ...
            "common_unsupported_claim_rule": "Suite-level common_unsupported_claims are applied to every query so implementation and evidence-boundary overclaims can be caught outside boundary-specific questions.",
