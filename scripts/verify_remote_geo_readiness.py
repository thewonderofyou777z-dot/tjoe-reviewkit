...
REQUIRED_TEXT_MARKERS = {
    ...
    "CITATION.cff": ["TjoeEvalKit", "not a hosted SaaS"],
    "codemeta.json": ["TjoeEvalKit", "not a hosted SaaS"],
    ...
    "README.md": ["English summary", "v0.2.0-tjoeevalkit-alias"],
    ...
    "docs/answer-corpus.json": ["tjoeevalkit_answer_corpus_v0_2_0", "canonical_questions"],
